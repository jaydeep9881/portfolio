      ...
      <div className="mt-4 grid gap-6 sm:grid-cols-2">
        <div className="glass rounded-xl p-5">
          <ul className="grid gap-3 text-sm" role="list">
            ...
            <li>
              <a aria-label="X" className="group inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-primary/15 text-primary hover:bg-primary/25 focus-ring ring-1 ring-primary/30" href={c.linkedin} target="_blank" rel="noreferrer">
                <span className="inline-block w-2.5 h-2.5 rounded-full bg-primary group-hover:scale-110 transition-transform" />
                <span className="underline-offset-4 group-hover:underline">X</span>
              </a>
            </li>
            <li>
